...
import { FaCrown, FaBars, FaTimes, FaImages, FaTag, FaCoins } from "react-icons/fa";
import { SiVercel } from "react-icons/si";

const DEPLOY_URL =
  "https://vercel.com/new/clone?repository-url=https://github.com/SamurAIGPT/ai-royal-portrait";

const NAV_LINKS = [
  { href: "/", label: "Studio", icon: <FaCrown className="text-xs" /> },
    ...
    <header className="sticky top-0 z-50 border-b border-zinc-800 bg-zinc-950/90 backdrop-blur-md">
      <div className="mx-auto max-w-7xl px-4 h-14 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center gap-2 shrink-0">
          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-yellow-400 to-yellow-700 flex items-center justify-center shadow-lg">
            <FaCrown className="text-zinc-950 text-xs" />
          </div>
          <span className="font-bold text-sm text-white tracking-tight hidden sm:block">
            AI Royal <span className="text-gradient-gold">Portrait</span>
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          {session ? (
            <div className="flex items-center gap-2">
              ...
              <Link
                href="/pricing"
                className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 text-xs font-semibold hover:bg-yellow-500/20 transition-all"
              >
              ...
              <div className="relative group">
                <img
                  ...
                  className="w-7 h-7 rounded-full border border-zinc-700 cursor-pointer hover:border-yellow-500 transition-all object-cover"
                />
            ...
            <button
              ...
              className="px-4 py-1.5 rounded-lg bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-zinc-950 text-xs font-bold transition-all shadow-lg hover:shadow-yellow-500/20"
            >
              Sign in with Google
            </button>
          )}
        ...
        <div className="flex md:hidden items-center gap-2">
          {session && (
            <Link
              href="/pricing"
              className="flex items-center gap-1 px-2 py-1 rounded-lg bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 text-xs font-semibold"
            >
              <FaCoins className="text-[10px]" />
              {session.user.credits ?? 0}
            </Link>
          ...
          <div className="px-4 py-4 flex flex-col gap-1">
            ...
            {session ? (
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-gradient-to-r from-yellow-500 to-yellow-600 text-zinc-950 text-sm font-bold"
              >
                Sign in with Google
              </button>
            )}
